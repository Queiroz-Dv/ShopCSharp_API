...
namespace ShopCSharp_API.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            var employee = new User { Id = 1, Username = "queiroz", Password = "queiroz", Role = "employee" };
            var manager = new User { Id = 2, Username = "naylane", Password = "naylane", Role = "manager" };
